    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="mt-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[var(--muted)]">
              Só o administrador cadastra contas. Quem for criado aqui entra em /login com usuário e senha.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <label className="space-y-1.5 text-sm">
            <span className="text-[var(--muted)]">Senha inicial</span>
            <input
              required
              type="password"
              minLength={8}
        ...
        <section className="mt-8">
          ...
          {loading ? (
            ...
            <ul className="mt-3 divide-y divide-[var(--line)] overflow-hidden rounded-2xl border border-[var(--line)]">
              {users.map((u) => (
                <li key={u.id} className="flex items-center justify-between gap-3 bg-black/20 px-4 py-3">
