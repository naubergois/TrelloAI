...
export function MeetingsPanel({
  ...
  return (
    <aside className="anim-rise flex w-full shrink-0 flex-col overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--panel-strong)] lg:w-[380px]">
      ...
      <div className="board-scroll flex-1 space-y-5 overflow-y-auto p-4">
        <section>
